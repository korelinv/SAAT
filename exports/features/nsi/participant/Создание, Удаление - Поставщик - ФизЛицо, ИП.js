...
new $Feature('dist/features/nsi/participant/Создание, Удаление - Поставщик - ФизЛицо, ИП')
.Tag('Создание')
.Tag('Удаление')
.Tag('НСИ')
.Tag('Участники')
.Tag('Поставщик')
.Tag('Поставщик.физлицо.ИП')

.Feature('Поставщик (физлицо, ИП)')

.Background('', new $Sequence()
.Given('Я логинюсь под пользователем "modifier"')

.Comment('Создаем поставщика (физлицо, ИП) а затем удаляем его')
...
.Then('Я нажимаю на кнопку с текстом "Далее"')
.Then('Я выбираю "Индивидуальный предприниматель" из списка опций "Тип"')
.Then('Я нажимаю на кнопку с текстом "Далее"')
.Then('Я нажимаю на кнопку с текстом "Далее"')
...
.And('Я заполняю поле "ОГРНИП" текстом "112123123123123"')
...
.And('Я заполняю поле "ОКПО" текстом "1234567890"')
