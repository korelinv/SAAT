...
new $Feature('dist/features/nsi/participant/Создание, Удаление - Поставщик - ЮрЛицо')
.Tag('Создание')
.Tag('Удаление')
.Tag('НСИ')
.Tag('Участники')
.Tag('Поставщик')
.Tag('Поставщик.юрлицо')

.Feature('Поставщик (юрлицо)')

.Background('', new $Sequence()
.Given('Я логинюсь под пользователем "modifier"')

.Comment('Создаем поставщика (юрлицо, РФ) а потом удаляем его')
.Comment('https://wiki.proitr.ru/pages/viewpage.action?pageId=126194101')
)
