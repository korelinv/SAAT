...
new $Feature('dist/features/nsi/participant/Создание, Удаление - Поставщик - ФизЛицо, без ИНН, не РФ')
.Tag('Создание')
.Tag('Удаление')
.Tag('НСИ')
.Tag('Участники')
.Tag('Поставщик')
.Tag('Поставщик.физлицо.без-инн.не-рф')

.Feature('Поставщик (физлицо, без ИНН, не РФ)')

.Background('', new $Sequence()
.Given('Я логинюсь под пользователем "modifier"')

.Comment('Создаем поставщика (физлицо, без ИНН, не РФ) а затем удаляем егоы')
