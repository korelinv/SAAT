...
new $Feature('dist/features/price/Создание - Оферта поставщиков')
.Tag('ЦЕНОВЫЕ-СПРАВОЧНИКИ')
.Tag('ЦЕНЫ')
.Tag('ОФЕРТЫ-ПОСТАВЩИКОВ')

.Feature('Создание оферты поставщиков')
...
.Scenario('Создание оферты поставщиков', new $Sequence()
...
.And('Я нажимаю на ссылку "Оферты поставщиков"')
.And('Я нажимаю на кнопку создания')
.And('Я заполняю поле "Наименование позиции" текстом "Тестовая позиция"')
...
.And('Я нажимаю на кнопку сохранения')
.Then('Я ожидаю, что заголовок содержит "Информация о оферте поставщиков"')
