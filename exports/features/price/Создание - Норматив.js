...
new $Feature('dist/features/price/Создание - Норматив')
.Tag('ЦЕНОВЫЕ-СПРАВОЧНИКИ')
.Tag('ЦЕНЫ')
.Tag('НОРМАТИВЫ')

.Feature('Создание норматива')
...
.Scenario('Создание норматива', new $Sequence()
...
.And('Я нажимаю на ссылку "Нормативы"')
...
.And('Я выбираю в поле с выпадающим списком "Валюта"')
.And('Я выбираю в поле с выпадающим списком "Источник данных"')
.And('Я заполняю календарь "Дата начала действия"')
.And('Я загружаю файл "uploadFiles/test.jpg" в поле "Документ"')
.And('Я нажимаю на кнопку сохранения')
.Then('Я ожидаю, что заголовок содержит "Информация о нормативе"')
