...
new $Feature('dist/features/price/Создание - Рыночная цена')
.Tag('ЦЕНОВЫЕ-СПРАВОЧНИКИ')
.Tag('ЦЕНЫ')
.Tag('РЫНОЧНЫЕ-ЦЕНЫ')

.Feature('Создание рыночной цены')
...
.Scenario('Создание рыночной цены', new $Sequence()
...
.And('Я нажимаю на ссылку "Рыночные цены"')
.And('Я нажимаю на кнопку создания')
.And('Я заполняю поле "Наименование позиции" сгенерированным тегом "Тестовая рыночная цена"')
...
.And('Я выбираю в поле с выпадающим списком "Поставщик (участник кс)"')
.And('Я заполняю календарь "Дата начала действия"')
.And('Я нажимаю на кнопку сохранения')
.Then('Я ожидаю, что заголовок содержит "Информация о рыночной цене"')
