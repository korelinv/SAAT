...
new $Feature('dist/features/price/Создание - Удельный показатель')
.Tag('ЦЕНОВЫЕ-СПРАВОЧНИКИ')
.Tag('ЦЕНЫ')
.Tag('УДЕЛЬНЫЕ-ПОКАЗАТЕЛИ')

.Feature('Создание удельного показателя')
...
.Scenario('Создание удельного показателя', new $Sequence()
...
.And('Я нажимаю на ссылку "Удельные показатели"')
.And('Я нажимаю на кнопку создания')
.And('Я заполняю поле "Цена аналога" текстом "10000"')
.And('Я заполняю поле "Объём аналога" текстом "10"')
...
.And('Я нажимаю на кнопку сохранения')
.Then('Я ожидаю, что заголовок содержит "Информация об удельном показателе"')
